...
/**
 * Utente registrato con ruolo di cliente: puo' cercare ristoranti,
 * gestire una lista di preferiti e inserire/modificare/cancellare
 * recensioni.
 */
public class Cliente extends Utente {
    ...
    public Cliente(int id, String nome, String cognome, String email, String username, LocalDate dataNascita,
